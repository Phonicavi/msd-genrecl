...
USED_GENRES = [1,1,0,0,1]				## remained to be XJBplay
...
def NNet():
	...
	model.fit(np.array(TrainX), TrainY, batch_size=int(len(TrainX)*.9),nb_epoch = 6000,shuffle=True,verbose=1,validation_split=0.1)
