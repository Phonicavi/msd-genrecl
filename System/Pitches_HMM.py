...
def classifierByHmm(n_cpnts = 4,covariance_type_ = 'tied'):
	...
	allGenreSongsTrain,allGenreSongsTest = fetchData_PH(NUM_NEED_PER_GENRE,GENRES,NeedReFetch,USED_GENRES,used_what)
	...
	if needTrain:
		...
		for i in range(sum(USED_GENRES)):
			...
			TASK.append(threading.Thread(target = thd,args = (i,seq_all,len_all,n_cpnts,200,3)))
